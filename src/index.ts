...
type ReturnTypeFetesAlsace = ReturnTypeFetesMetropole &
  ReturnType<typeof fetesAlsace>;
...
function getJoursFeries(
  year: number
): ReturnTypeFetesMetropole;
function getJoursFeries(
  year: number,
  options: { zone: "métropole" }
): ReturnTypeFetesMetropole;
function getJoursFeries(
  year: number,
  options: { zone: "alsace-moselle" }
): ReturnTypeFetesAlsace;
function getJoursFeries(
  year: number,
