import { joursFeries, isJourFerie } from "../src/index";
...
test("should return true for Armistice 2018", () => {
  expect(isJourFerie(new Date(2018, 10, 11))).toBe(true);
});

test("should return true for Ascension 2018", () => {
  expect(isJourFerie(new Date(2018, 4, 10))).toBe(true);
});

test("should return false for 2018-01-05", () => {
  expect(isJourFerie(new Date(2018, 0, 5))).toBe(false);
});

test("should return true for Saint Étienne 2018 in alsace-moselle", () => {
  expect(isJourFerie(new Date(2018, 11, 25), { zone: "alsace-moselle" })).toBe(
    true
  );
});
